...
public class CameraSurfaceView extends ViewGroup implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    class ConnectWSTask extends AsyncTask<byte[], Void, Boolean> {
    ...
    class SendFrameTask extends AsyncTask<byte[], Void, Boolean> {
    ...
    public void setCamera(Camera camera)
    {
        ...
        if (mCamera != null)
        {
            ...
            setSupportedPreviewSizes(mSupportedPreviewSizes);
